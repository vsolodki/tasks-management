class TagAssociationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tag_association.save
        ...
        format.json { render :show, status: :created, location: @tag_association }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tag_associations_url, notice: 'Tag association was successfully destroyed.' }
